...
if (!defined('_ARTX_FUNCTIONS')) {
    ...
    function artxPost($data)
    {
    	...
    	artxFragmentBegin(str_replace('class="cul-box cul-post">', 'class="cul-box cul-post' . $classes . '">', "<div class=\"cul-box cul-post\">\r\n    <div class=\"cul-box-body cul-post-body\">\r\n<div class=\"cul-post-inner\">\r\n"));
    	artxFragmentBegin("<h2 class=\"cul-postheader\">");
    	artxFragmentBegin("");
...
?>
        <?php ob_start(); ?>
<div class="cul-box cul-block">
            <div class="cul-box-body cul-block-body">
        
        <?php echo str_replace('class="cul-box cul-block">', 'class="cul-box cul-block' . $classes . '">', ob_get_clean()); ?>
        <?php if ($hasCaption): ?>
<div class="cul-bar cul-blockheader">
            <h3 class="t">
        <?php echo $caption; ?>
</h3>
        </div>
        <?php endif; ?>
        <?php if ($hasContent): ?>
<div class="cul-box cul-blockcontent">
            <div class="cul-box-body cul-blockcontent-body">
...
?><div class="cul-box cul-vmenublock">
    <div class="cul-box-body cul-vmenublock-body">
<?php

        echo str_replace('class="cul-box cul-vmenublock">', 'class="cul-box cul-vmenublock' . $classes . '">', ob_get_clean());
        if ($hasCaption):
?><div class="cul-bar cul-vmenublockheader">
    <h3 class="t"><?php
...
?></h3>
        ...
        if ($hasContent):
?><div class="cul-box cul-vmenublockcontent">
    <div class="cul-box-body cul-vmenublockcontent-body">
<?php
...
<?php
    ...
    function artxModules(&$document, $position, $style = null)
    {
         ...
         *  Select inputs with class != 'cul-button'
         *   artxFindTags($html, array('input' => array('class' => '!cul-button')))
         *  Select inputs with non-empty class
         *   artxFindTags($html, array('input' => array('class' => '!')))
         *  Select inputs with class != 'cul-button' and non-empty class:
         *   artxFindTags($html, array('input' => array('class' => array('!cul-button', '!'))))
         *  Select inputs with class = button but != 'cul-button'
         *   artxFindTags($html, array('input' => array('class' => array('button', '!cul-button'))))
         *
        ...
        function artxReplaceButtons($content, $filter = array('input' => array('class' => 'button')))
        {
            ...
            foreach (artxFindTags($content, $filter) as $tag) {
                if (is_string($tag))
                    ...
                    $tag['attributes']['class']['value'][] = 'cul-button';
                    $delimeter = '' == $tag['attributes']['class']['delimeter']
                        ? '"' : $tag['attributes']['class']['delimeter'];
                    $tag['attributes']['class']['delimeter'] = $delimeter;
                    $button = str_replace('"', $delimeter, '<span class="cul-button-wrapper">'
                        . '<span class="cul-button-l"> </span><span class="cul-button-r"> </span>')
        ...
        {
            return '<span class="cul-button-wrapper"><span class="cul-button-l"> </span><span class="cul-button-r"> </span>'
                . '<a class="' . (isset($data['classes']) && isset($data['classes']['a']) ? $data['classes']['a'] . ' ' : '')
                . 'cul-button" href="' . $data['link'] . '">' . $data['content'] . '</a></span>';
        }
...
function artxPostprocessBlockContent($content)
    ...
    {
        $content = artxReplaceButtons($content, array('input' => array('class' => array('button', '!cul-button')),
            'button' => array('class' => array('button', '!cul-button'))));
        return $content;
    }
